...
WINBOOL WINAPI utm_DestroyAcceleratorTable(HACCEL accelerator){UT_ASSERT_EQ_PTR(ut_info.hacclFrameCommands,accelerator);++ut_accel_calls;return(TRUE);}
WINBOOL WINAPI utm_DestroyWindow(HWND window){UT_ASSERT_EQ_PTR((HWND)(UINT_PTR)1,window);++ut_window_calls;return(TRUE);}
