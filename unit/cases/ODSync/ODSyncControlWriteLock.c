...
#define UT_CUSTOM_MOCK_ODControlWriteAcquire
#define UT_CUSTOM_MOCK_ODSyncIsOwnerThread
static BOOL ut_owner;
static unsigned ut_acquires;

void utm_ODControlWriteAcquire(void) { ++ut_acquires; }
...
static const UTTestCase ut_cases[] = {
   {"write acquire dispatch", acquires_unless_an_active_api_owner_already_has_exclusion}
};
