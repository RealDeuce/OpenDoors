...
must be supplied; passing two null pointers sets `od_control.od_error` to
`ERR_PARAMETER`.
...
[`od_set_cursor()`](od_set_cursor.md), [Terminal and screen model](../../guides/terminal-screen.md)
