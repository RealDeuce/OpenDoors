...
colors, blank character, and `EDIT_*` flags control presentation and behavior.
...
`ERR_PARAMETER`; unavailable graphics sets `ERR_NOGRAPHICS`.

## See also

[`od_input_str()`](od_input_str.md),
[`od_multiline_edit()`](od_multiline_edit.md), [Constants and flags](../constants.md)
