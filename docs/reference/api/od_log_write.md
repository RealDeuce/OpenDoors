...
message format. The function returns true when logging succeeds. A null message,
disabled or unavailable logging component, or write failure returns false and
sets [`od_control.od_error`](../control/runtime.md) where applicable.
