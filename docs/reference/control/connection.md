...
| `od_com_method` | One of the `COM_*` communication methods. |
...
The lower-level serial fields remain for established DOS and BBS
configurations. New network-hosted doors normally receive their communication
method and handle from Door32 or the invoking server.
